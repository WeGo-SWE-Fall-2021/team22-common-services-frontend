...
function showAlert(text) {
    ...
    $("#hero-section").removeClass('nav-height-padding').addClass('alert-height-with-nav-padding');
...
function hideAlert() {
    ...
    $("#hero-section").addClass('nav-height-padding').removeClass('alert-height-with-nav-padding');
